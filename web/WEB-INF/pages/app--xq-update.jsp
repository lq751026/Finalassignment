...
<head>
	...
	<link rel="stylesheet"
		  href="${pageContext.request.contextPath}/css/sstyle.css">
	<link rel="stylesheet"
...
<div class="wrapper">
						...
						<div class="king-layout1-main clearfix">
							...
							<div class="king-content-wrap">
								<div class="king-layout1-content" style="margin-left: 216px;">
									<form class="form-horizontal" action="${pageContext.request.contextPath}/update-dealWith" method="post" enctype="multipart/form-data">
										<%--
										 /*** null */
  private Integer id;
  ...
  private String versions; //版本号
										...
										--%>
										<input value="${app.id}" name="id" type="hidden">
										<div class="form-group clearfix ">
											<label class="col-sm-3 control-label bk-lh30 pt0">名称：</label>
											<div class="col-sm-9">
												<input type="text" id="popo1" disabled="disabled" name="name" value="${app.name}" class="form-control bk-valign-top"  placeholder="请输入你的app名称"> </div>
										</div>
										<div class="form-group clearfix ">
											<label class="col-sm-3 control-label bk-lh30 pt0">软件大小（mb）：</label>
											<div class="col-sm-9">
												<input name="size"  id="popo2" disabled="disabled" value="${app.size}" type="text" class="form-control bk-valign-top"  placeholder="请输入你app的软件大小">
											</div>
										</div>
										<div class="form-group clearfix ">
											<label class="col-sm-3 control-label bk-lh30 pt0">软件支持的平台：</label>
											<div class="col-sm-9">
												<input type="text" id="popo3"   disabled="disabled" name="platform" value="${app.platform}" class="form-control bk-valign-top"  placeholder="请输入你app软件支持的平台">
											</div>
										</div>
										<div class="form-group clearfix ">
											<label class="col-sm-3 control-label bk-lh30 pt0">版本号：</label>
											<div class="col-sm-9">
												<input type="text"  id="popo4"  disabled="disabled" name="versions" value="${app.versions}" class="form-control bk-valign-top"  placeholder="app的版本号"> </div>
										</div>
											<%--
  ...
  private String downtimes ;//下载次数--%>
											<div class="form-group clearfix ">
												...
												<div class="col-sm-9">
													<input type="text"  id="popo5"  disabled="disabled" name="deploy" value="${app.deploy}" class="form-control bk-valign-top"  placeholder="app的最低配置"> </div>
											</div>
											<div class="form-group clearfix ">
												<label class="col-sm-3 control-label bk-lh30 pt0">界面语言：</label>
												<div class="col-sm-9">
													<input type="text"  id="popo6"  disabled="disabled" name="language" value="${app.language}" class="form-control bk-valign-top"  placeholder="app的语言"> </div>
											</div>
											<div class="form-group clearfix ">
												<label class="col-sm-3 control-label bk-lh30 pt0">下载次数：</label>
												<div class="col-sm-9">
													<input type="text"  id="popo7"  disabled="disabled" name="downtimes" value="${app.downtimes}" class="form-control bk-valign-top"  placeholder="app的下载次数"> </div>
											</div>


											<div class="form-group clearfix ">
												<label class="col-sm-3 control-label bk-lh30 pt0">软件的logo：</label>
												<div class="col-sm-9">
													<img src="${pageContext.request.contextPath}/${app.logo}" alt=""> </div>
											</div>
										<div class="form-group clearfix ">
										...
										<div class="form-group clearfix">
											<div class="col-sm-9 col-sm-offset-3">
												<input type="button" id="btssn" class="king-btn mr10  king-success" value="修改"></input>
												<input type="hidden" id="bts" class="king-btn mr10  king-success" value="确认修改"></input>

												<script >

													 document.getElementById("btssn").onclick=function (){
													     if(${app.status==3}){
                                                              alert("请你联系开发者下架了才能进行修改哦亲！")
														 }else{
                                                             update($("#popo1"));
                                                             update($("#popo2"));
                                                             update($("#popo3"));
                                                             ...
                                                             update($("#popo7"));
                                                             this.type="hidden";
                                                             document.getElementById("bts").type="submit";
                                                         }
